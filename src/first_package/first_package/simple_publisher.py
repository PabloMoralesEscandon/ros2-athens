...
class MinimalPublisher(Node):
    def __init__(self):
        ...
        super().__init__('node_de_PABLO')  # <-- Replace 'NICKNAME' with your actual group number
        
        # Step 2: Create a publisher for your topic
        # Replace 'topic_ID' with a unique topic name (e.g., 'topic_1' for Group 1)
        self.publisher_ = self.create_publisher(ExampleMessage, 'topic_de_PABLO', 10)  # <-- Replace 'NICKNAME'
        ...
        self.i = 0.0  # Starts counting from 0
    ...
    def timer_callback(self):
        ...
        #msg.data = f"Group 5 says hello! No hacer rima por favor. This is message #{self.i}"  # <-- Replace 'NICKNAME'
        
        # Publish the message
        self.publisher_.publish(msg)
        
        # Log the published message to the console
        self.get_logger().info(f'Publishing: "{msg.cord_x}"')
