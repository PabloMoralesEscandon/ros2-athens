...
class MinimalSubscriber(Node):
    def __init__(self):
        ...
        super().__init__('node_de_PABLO_rec')  # <-- Replace 'NICKNAME' with your actual group number
        ...
        self.subscription = self.create_subscription(
            ExampleMessage,             # Message type used by the publisher
    ...
    def listener_callback(self, msg):
        ...
        self.get_logger().info(f'Received: "{msg.cord_x}"')
